program Nathan.Cache.IntegrationTests;
...
uses
  ...
  Cache.Manager.IntegrationTests in 'Cache.Manager.IntegrationTests.pas',
  Cache.Manager.Generics.IntegrationTests in 'Cache.Manager.Generics.IntegrationTests.pas',
